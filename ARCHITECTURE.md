...
这份文档讲代码结构和系统分层，不重复讲设计规范。设计规范看 `AGENTS.md`。
...
1. `AI 对话层`
   - 作用：接收设计师意图，决定改内容、改排版、改顺序还是改版本

2. `预览与工作台层`
   - 作用：把页面渲染出来，提供预览、小地图、缩放、产品图微调、导出

3. `模板与装配层`
   - 作用：定义每种物料的页面结构、页面顺序、章节关系和版本差异

4. `数据与素材层`
   - 作用：存产品主数据、语言文案、参数表、素材路径和版本引用关系

5. `审校操作层`
   - 作用：承接 AI 审校结果导入、页面错误标注、忽略规则、自动写回、checkpoint
