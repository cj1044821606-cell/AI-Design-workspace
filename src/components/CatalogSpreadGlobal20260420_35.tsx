...
export default function CatalogSpreadGlobal20260420_35() {
  return (
          ...
          <table className="w-full border-collapse text-[6pt] text-center" style={{ fontFamily: '"Mark OT", sans-serif' }}>
            <tbody>
              ...
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                ...
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">37.45鍗&plusmn;%</td>
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">35.05鍗&plusmn;%</td>
              </tr>
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle text-left">Short Circuit Current - Isc (A)</td>
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">13.85鍗&plusmn;%</td>
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">11.16鍗&plusmn;%</td>
              </tr>
              <tr className="bg-[#dbdcdb] text-[#231A16]">
              ...
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                ...
                <td colSpan={2} className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">45鍗&plusmn;</td>
              </tr>
