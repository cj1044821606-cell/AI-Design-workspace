...
export default function CatalogSpreadGlobal20260420_33() {
  return (
    <div className="w-[420mm] h-[297mm] bg-white relative overflow-hidden shadow-sm flex">
      ...
      <div className="w-[210mm] h-full relative z-10">
        ...
        <div className="design-group-wrapper absolute left-[105.7mm] top-[86.84mm] w-[90.83mm] h-[113.22mm] z-10">
          ...
          <ProductImageEditor 
            src={productImage} 
            componentName="CatalogSpreadGlobal20260420_33"
      ...
      <div className="w-[210mm] h-full relative">
        <div className="design-group-wrapper absolute left-[38.151mm] top-[15.63mm] w-[150.099mm] z-10">
          ...
          <table className="w-full border-collapse table-fixed text-[5.4pt] text-center" style={{ fontFamily: '"Mark OT", sans-serif' }}>
            <colgroup>
              <col style={{ width: '44%' }} />
              <col style={{ width: '56%' }} />
            </colgroup>
            <tbody>
              ...
              <tr className="bg-[#9e9e9e] text-white font-bold">
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[1.6mm] align-middle">Model</td>
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[1.6mm] align-middle">IPX-51314SPT</td>
              </tr>
              ...
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                ...
                <td className="border-[0.368pt] border-white h-[4.551mm] align-middle p-0">
                  <table className="w-full h-full border-collapse">
                    <tbody>
                      <tr>
                        <td className="border-b-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">0~55&deg;C</td>
                      </tr>
                      <tr>
                        <td className="h-[4.551mm] px-[2mm] align-middle">-10~55&deg;C</td>
                      </tr>
                    </tbody>
                  </table>
                </td>
              ...
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle text-left">Wi-Fi Frequency Range</td>
