...
import productImg from '@/画册素材库/产品素材/IPL-51200X.png';
import bgImage from '@/画册素材库/背景素材/画册-23-产品页左上角背景.png';
import { ProductImageEditor } from './ProductImageEditor';

export default function CatalogSpreadGlobal20260420_23() {
  return (
    <div className="w-[420mm] h-[297mm] bg-white relative overflow-hidden shadow-sm flex">
      ...
      <div className="w-[210mm] h-full relative z-10">
        ...
        <div className="design-group-wrapper absolute left-[100.7mm] top-[106.84mm] w-[100.83mm] h-[93.22mm] z-10">
          ...
          <ProductImageEditor src={productImg} componentName="CatalogSpreadGlobal20260420_23" initialX={1} /* IMAGE_TRANSFORM_X */ initialY={-56} /* IMAGE_TRANSFORM_Y */ initialScale={1.05} /* IMAGE_TRANSFORM_SCALE */ defaultHeight="100%" defaultMarginLeft="0" />
        </div>
        ...
        <div className="design-group-wrapper absolute left-[20.9mm] top-[169.83mm] flex items-center z-10">
          ...
          <div className="bg-[#ED1651] h-[11.2mm] px-4 flex items-center justify-center rounded-l-md z-20">
            <span className="text-white font-bold text-[16pt]" style={{ fontFamily: '"Mark OT", sans-serif' }}>51.2V-10.24kWh</span>
          </div>
          <div className="bg-[#ACADB1] h-[11.2mm] px-4 flex items-center justify-center rounded-r-md -ml-2 pl-6 z-10">
            <span className="text-white font-bold text-[16pt]" style={{ fontFamily: '"Mark OT", sans-serif' }}>200Ah</span>
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 gap-x-[10mm] gap-y-[6mm]">
            ...
            <div className="flex items-start gap-[4mm]">
              ...
              <div className="flex flex-col gap-[1mm]">
                ...
                <p className="text-[#5A5A5C] font-normal text-[8pt] leading-[1.4]" style={{ fontFamily: '"MiSans", sans-serif' }}>
                  ...
                  Max. Discharge Power up to 16kW@10s
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-[4mm]">
              ...
              <div className="flex flex-col gap-[1mm]">
                ...
                <p className="text-[#5A5A5C] font-normal text-[8pt] leading-[1.4]" style={{ fontFamily: '"MiSans", sans-serif' }}>
                  ...
                  No Dip Switch, Automatic Set to Parallel Address<br/>
                  Automatic Assign Master and Slave
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-[4mm]">
              ...
              <div className="flex flex-col gap-[1mm]">
                ...
                <p className="text-[#5A5A5C] font-normal text-[8pt] leading-[1.4]" style={{ fontFamily: '"MiSans", sans-serif' }}>
                  Cells Contact System(CCS) Integrated Design and<br/>
          ...
          <table className="w-full border-collapse text-[6pt] text-center" style={{ fontFamily: '"Mark OT", sans-serif' }}>
            <tbody>
              ...
              <tr className="bg-[#9e9e9e] text-white font-bold">
                ...
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle w-1/2">IPL-51200X</td>
              </tr>
              ...
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                ...
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">210@13s</td>
              </tr>
              <tr className="bg-[#dbdcdb] text-[#231A16]">
              ...
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                ...
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">240*454*635</td>
              </tr>
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle text-left">Net Weight (kg)</td>
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">88</td>
              </tr>
              <tr className="bg-[#dbdcdb] text-[#231A16]">
