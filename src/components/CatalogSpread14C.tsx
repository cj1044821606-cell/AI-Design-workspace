...
export default function CatalogSpread14C() {
  return (
    <div className="w-[420mm] h-[297mm] bg-white relative overflow-hidden shadow-sm flex">
      ...
      <div className="w-[210mm] h-full relative z-10">
        ...
        <div className="design-group-wrapper absolute left-[128.7mm] top-[106.84mm] w-[68.83mm] h-[93.22mm] z-10">
          ...
          <ProductImageEditor src={inverterImg} componentName="CatalogSpread14C" initialX={-57} /* IMAGE_TRANSFORM_X */ initialY={-54} /* IMAGE_TRANSFORM_Y */ initialScale={1.55} /* IMAGE_TRANSFORM_SCALE */ defaultHeight="100%" defaultMarginLeft="0" />
        </div>
