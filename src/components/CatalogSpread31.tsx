...
export default function CatalogSpread31() {
  return (
    <div className="w-[420mm] h-[297mm] bg-white relative overflow-hidden shadow-sm flex">
      {/* ================= 闂傚倷娴囬褎顨ラ崫銉х濠电姴鍋嗛悞浠嬫煠婵劕鈧绋夊澶嬬厵闁硅鍔﹂崵娆愭交&plusmn;================= */}
      <div className="w-[210mm] h-full relative z-10">
        {/* 闂傚倷娴囬褎顨ラ崫銉х濠电姴鍋嗛悞浠嬫煠婵劕鈧澹曢懞銉﹀弿婵☆垰銇橀崥顐ょ磼閻樿櫕顥堥柡灞剧〒娴狅箓宕滆閻撲線姊洪崫銉バ㈡俊顐ｇ箞瀵鎮㈤崗鐓庘偓缁樹繆椤栨繂鍚规い锔哄劦濮婃椽宕ㄦ繝鍐ㄧ缂傚倸绉撮敃顏勵嚕婵犳碍鏅搁柣妯哄级閵囨繃绻涙潏鍓у埌闁硅姤绮嶇粋鎺楀煛娴ｅ弶鏂€&plusmn;*/}
        ...
        {/* 婵犵數鍋涢悺銊х尵閸岀偛绀冮柍鍝勫€搁崜顒勬⒒&plusmn;(闂傚倷绀侀幉锟犳偡瑜庨幈銊р偓娑櫳戦崣蹇涙煟閹邦剚鎯堥柟鐟扮埣閺屾洘绻涢崹顔煎缂備降鍔嶅畝鎼佸蓟閿熺姴妞藉ù锝呮憸娴犫晛鈹戦悙鑼憼闁挎洏鍨归悾鐑芥晲婢跺﹦顦ч梺鍛婁緱閸ㄦ娊骞夐鈧弻&plusmn; */}
        <div className="design-group-wrapper absolute left-[85.7mm] top-[106.84mm] w-[110.83mm] h-[93.22mm] z-10">
          <div className="design-group-label">&plusmn;&plusmn;&plusmn;</div>
          <ProductImageEditor 
            src={productImage} 
            componentName="CatalogSpread31"
        ...
        {/* 闂傚倷绀侀幉鈥愁潖婵犳艾绐楅柟鐐墯閸熷懘鏌ｉ幘鍐茬槰闁搞倖顨婇弻銈夊箒閹烘垵濮㈤梺&plusmn;*/}
        ...
        {/* Product Features 闂傚倷绀侀幖顐ょ矓閺夋嚚娲敇椤兘鍋&plusmn;*/}
        ...
        {/* 闂傚倷绀侀幉锛勬暜閹烘嚦娑樷攽閸″繑鐏侀悷婊冪箻閹偓&plusmn;*/}
        ...
        {/* 闂傚倷鑳剁划顖炪€冩径鎰剁稏濠㈣埖鍔曢悞鍨亜閹搭厼澧柛鐕佸亰閹ê鈻庨幘鏉戜哗&plusmn;Grid */}
      ...
      {/* ================= 闂傚倸鍊搁崐椋庣矆娓氣偓楠炲鏁撻悩鍐蹭画闂佹寧姊婚弲顐ょ不閹€鏀介柣妯哄级閹兼劖娼&plusmn;================= */}
