...
export default function CatalogSpreadUZ01() {
  return (
    <div className="w-[420mm] h-[297mm] bg-white relative overflow-hidden shadow-sm">
      ...
      {/* [二维码乚 */}
      <div className="design-group-wrapper absolute left-[15mm] bottom-[26mm] z-10">
        <div className="design-group-label">二维码</div>
        <div className="flex items-end gap-[2mm]">
          <img src={qrCode2} alt="Instagram QR Code" className="w-[27mm] h-[27mm] object-contain" />
          <img src={qrCode1} alt="Facebook QR Code" className="w-[27mm] h-[27mm] object-contain" />
        </div>
      </div>
      ...
      <div className="design-group-wrapper absolute left-[115mm] bottom-[15mm] z-10">
        ...
        <div className="whitespace-nowrap">
          ...
          <span className="text-[10pt] font-misans font-semibold text-gray-700">Uzbekistan Version 1.0</span>
        </div>
      </div>
