...
export default function CatalogSpreadGlobal20260420_06() {
  return (
    <div className="w-[420mm] h-[297mm] bg-white relative overflow-hidden shadow-sm flex">
      ...
      <div className="w-[210mm] h-full relative z-10">
        ...
        <div className="design-group-wrapper absolute left-[128.7mm] top-[106.84mm] w-[68.83mm] h-[93.22mm] z-10">
          ...
          <ProductImageEditor src={inverterImg} componentName="CatalogSpreadGlobal20260420_06" initialX={13} /* IMAGE_TRANSFORM_X */ initialY={-61} /* IMAGE_TRANSFORM_Y */ initialScale={1.65} /* IMAGE_TRANSFORM_SCALE */ defaultHeight="100%" defaultMarginLeft="0" />
        </div>
            ...
            <div className="flex items-start gap-[4mm]">
              ...
              <div className="flex flex-col gap-[1mm]">
                ...
                <p className="text-[#5A5A5C] font-normal text-[8pt] leading-[1.4]" style={{ fontFamily: '"MiSans", sans-serif' }}>
                  ...
                  Max. MPPT Charging Current up to 220A
                </p>
              </div>
            </div>
          ...
          <table className="w-full border-collapse text-[6pt] text-center" style={{ fontFamily: '"Mark OT", sans-serif' }}>
            <tbody>
              ...
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                ...
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">73 (Bypass Mode)</td>
              </tr>
              <tr className="bg-[#dbdcdb] text-[#231A16]">
              ...
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                ...
                <td colSpan={2} className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">Lead-acid/Lithium-ion/User-defined settings</td>
              </tr>
              <tr className="bg-[#dbdcdb] text-[#231A16]">
              ...
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                ...
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">Wi-Fi/RS485/CAN/RS232/Dry Contact</td>
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">Wi-Fi/RS485/CAN/Dry Contact</td>
              </tr>
              <tr className="bg-[#dbdcdb] text-[#231A16]">
              ...
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                ...
                <td colSpan={2} className="border-[0.368pt] border-white py-[2mm] px-[2mm] align-middle">Single Phase: 12<br/>Three Phase: 12</td>
              </tr>
              <tr className="bg-[#dbdcdb] text-[#231A16]">
