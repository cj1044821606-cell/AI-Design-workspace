...
import productImage from '@/画册素材库/产品素材/IGT-6KSA&8KSA10KSA.png';

export default function CatalogSpread33() {
  return (
      ...
      <div className="w-[210mm] h-full relative z-10">
        ...
        <div className="design-group-wrapper absolute left-[20.9mm] top-[169.83mm] flex items-center z-10">
          ...
          <div className="bg-[#ED1651] h-[11.2mm] px-4 flex items-center justify-center rounded-l-md z-20">
            <span className="text-white font-bold text-[16pt]" style={{ fontFamily: '"Mark OT", sans-serif' }}>6~12kW</span>
          </div>
          ...
          <table className="w-full border-collapse text-[6pt] text-center" style={{ fontFamily: '"Mark OT", sans-serif' }}>
            <tbody>
              ...
              <tr className="bg-[#9e9e9e] text-white font-bold">
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle w-[34%]">Model</td>
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle w-[22%]">IGT-6KSA</td>
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle w-[22%]">IGT-8KSA</td>
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle w-[22%]">IGT-10KSA</td>
              </tr>
              ...
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                ...
                <td colSpan={3} className="border-[0.368pt] border-white py-[2mm] px-[2mm] align-middle">DC: Type II<br/>AC: Type II</td>
              </tr>
              ...
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                ...
                <td colSpan={3} className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">P66</td>
              </tr>
              <tr className="bg-[#dbdcdb] text-[#231A16]">
