...
export default function CatalogSpread22() {
  return (
    <div className="w-[420mm] h-[297mm] bg-white relative overflow-hidden shadow-sm flex">
      ...
      <div className="w-[210mm] h-full relative z-10">
        ...
        <div className="design-group-wrapper absolute left-[100.7mm] top-[106.84mm] w-[100.83mm] h-[93.22mm] z-10">
          ...
          <ProductImageEditor src={productImg} componentName="CatalogSpread22" initialX={1} /* IMAGE_TRANSFORM_X */ initialY={-79} /* IMAGE_TRANSFORM_Y */ initialScale={0.85} /* IMAGE_TRANSFORM_SCALE */ defaultHeight="100%" defaultMarginLeft="0" />
        </div>
