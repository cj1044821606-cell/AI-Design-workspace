...
export default function CatalogSpreadGlobal20260420_15() {
  return (
    <div className="w-[420mm] h-[297mm] bg-white relative overflow-hidden shadow-sm flex">
      ...
      <div className="w-[210mm] h-full relative z-10">
        ...
        <div className="design-group-wrapper absolute left-[100.7mm] top-[106.84mm] w-[100.83mm] h-[93.22mm] z-10">
          ...
          <ProductImageEditor src={inverterImg} componentName="CatalogSpreadGlobal20260420_15" initialX={21} /* IMAGE_TRANSFORM_X */ initialY={-40} /* IMAGE_TRANSFORM_Y */ initialScale={0.65} /* IMAGE_TRANSFORM_SCALE */ defaultHeight="100%" defaultMarginLeft="0" />
        </div>
