...
import productImg from '@/画册素材库/产品素材/IPL-51200&IPL-51280.png';
import bgImage from '@/画册素材库/背景素材/画册-19-产品页左上角背景.png';
import { ProductImageEditor } from './ProductImageEditor';

export default function CatalogSpreadUZ19() {
  return (
    <div className="w-[420mm] h-[297mm] bg-white relative overflow-hidden shadow-sm flex">
      ...
      <div className="w-[210mm] h-full relative z-10">
        ...
        <div className="design-group-wrapper absolute left-[100.7mm] top-[106.84mm] w-[100.83mm] h-[93.22mm] z-10">
          ...
          <ProductImageEditor src={productImg} componentName="CatalogSpreadUZ19" initialX={3} /* IMAGE_TRANSFORM_X */ initialY={-113} /* IMAGE_TRANSFORM_Y */ initialScale={0.8} /* IMAGE_TRANSFORM_SCALE */ defaultHeight="100%" defaultMarginLeft="0" />
        </div>
        ...
        <div className="design-group-wrapper absolute left-[20.9mm] top-[169.83mm] flex items-center z-10">
          ...
          <div className="bg-[#ED1651] h-[11.2mm] px-4 flex items-center justify-center rounded-l-md z-20">
            <span className="text-white font-bold text-[16pt]" style={{ fontFamily: '"Mark OT", sans-serif' }}>51.2V-10.24/14.33kWh</span>
          </div>
          <div className="bg-[#ACADB1] h-[11.2mm] px-4 flex items-center justify-center rounded-r-md -ml-2 pl-6 z-10">
            <span className="text-white font-bold text-[16pt]" style={{ fontFamily: '"Mark OT", sans-serif' }}>200/280Ah</span>
          </div>
        </div>
        ...
        <div className="design-group-wrapper absolute left-[21.5mm] top-[211mm] w-[167.2mm] z-10">
          ...
          <div className="grid grid-cols-2 gap-x-[10mm] gap-y-[6mm]">
            ...
            <div className="flex items-start gap-[4mm]">
              <div className="w-[9.46mm] h-[9.46mm] bg-[#ED1651] rounded-[2mm] shrink-0 mt-1"></div>
              <div className="flex flex-col gap-[1mm]">
                <h3 className="text-[#010202] font-medium text-[12pt]" style={{ fontFamily: '"MiSans", sans-serif' }}>Активный баланс</h3>
                <p className="text-[#5A5A5C] font-normal text-[8pt] leading-[1.4]" style={{ fontFamily: '"MiSans", sans-serif' }}>
                  3A Ток активного баланса для продления срока службы батареи
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-[4mm]">
              ...
              <div className="flex flex-col gap-[1mm]">
                ...
                <p className="text-[#5A5A5C] font-normal text-[8pt] leading-[1.4]" style={{ fontFamily: '"MiSans", sans-serif' }}>
                  Количество параллельных модулей: 15<br/> 50+ алгоритмов защиты;
                </p>
              </div>
            </div>
          ...
          <table className="w-full border-collapse text-[6pt] text-center" style={{ fontFamily: '"Mark OT", sans-serif' }}>
            <tbody>
              ...
              <tr className="bg-[#9e9e9e] text-white font-bold">
                ...
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle w-1/4">IPL-51200</td>
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle w-1/4">IPL-51280</td>
              </tr>
              ...
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                ...
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">280</td>
              </tr>
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                ...
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">14.33</td>
              </tr>
              <tr className="bg-[#dbdcdb] text-[#231A16]">
              ...
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                ...
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">150@1s</td>
              </tr>
              <tr className="bg-[#dbdcdb] text-[#231A16]">
              ...
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                ...
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">175*560*880</td>
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">230*560*880</td>
              </tr>
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                ...
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">118</td>
              </tr>
              <tr className="bg-[#dbdcdb] text-[#231A16]">
              ...
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                ...
                <td colSpan={2} className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">6 светодиодов (SOC), 2 светодиода (работа и сигнализация)</td>
              </tr>
              <tr className="bg-[#dbdcdb] text-[#231A16]">
