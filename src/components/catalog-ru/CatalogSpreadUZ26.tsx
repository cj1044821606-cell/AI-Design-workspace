          ...
          <div className="grid grid-cols-2 gap-x-[8mm] gap-y-[3mm]">
            ...
            <div className="flex items-start gap-[4mm]">
              ...
              <div className="flex flex-col gap-[1mm]">
                ...
                <p className="text-[#5A5A5C] font-normal text-[8pt] leading-[1.2]" style={{ fontFamily: '"MiSans", sans-serif' }}>
                  PV и двойная зарядка от сети, до 500W<br/> Полная зарядка аккумулятора за 2 часа
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-[4mm]">
              ...
              <div className="flex flex-col gap-[1mm]">
                ...
                <p className="text-[#5A5A5C] font-normal text-[8pt] leading-[1.2]" style={{ fontFamily: '"MiSans", sans-serif' }}>
                  Выдерживаемое фазное напряжение 380V,<br/> Самоадаптация к нестабильной электросети<br/> THDv&lt;3%, самоадаптация к слабой сети<br/> Интеллектуальный алгоритм управления питанием,<br/> Самоадаптация к бытовой технике
                </p>
              </div>
            </div>
          ...
          <table className="w-full border-collapse text-[6pt] text-center" style={{ fontFamily: '"Mark OT", sans-serif' }}>
            <tbody>
              ...
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                ...
                <td className="border-[0.368pt] border-white py-[2mm] px-[2mm] align-middle leading-tight">Выход CC 3.0A @ &gt;500W<br/>Выход фиксации @ &lt;165VAC</td>
              </tr>
              ...
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                ...
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">AC: Тип III</td>
              </tr>
            </tbody>
          </table>
        </div>
