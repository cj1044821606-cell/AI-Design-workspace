    ...
    <div className="w-[420mm] h-[297mm] bg-white relative overflow-hidden shadow-sm flex">
      ...
      <div className="w-[210mm] h-full relative z-10">
        ...
        <div className="design-group-wrapper absolute left-[20.9mm] top-[169.83mm] flex items-center z-10">
          ...
          <div className="bg-[#ED1651] h-[11.2mm] px-[6mm] flex items-center justify-center rounded-[4mm] z-20">
          ...
          <div className="grid grid-cols-2 gap-x-[8mm] gap-y-[5mm]">
            ...
            <div className="flex items-start gap-[4mm]">
              ...
              <div className="flex flex-col gap-[1mm]">
                ...
                <p className="text-[#5A5A5C] font-normal text-[8pt] leading-[1.25]" style={{ fontFamily: '"MiSans", sans-serif' }}>
                  Интеллектуальный EMS, ПК с двумя выходами и интеллектуальный BMS
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-[4mm]">
              ...
              <div className="flex flex-col gap-[1mm]">
                ...
                <p className="text-[#5A5A5C] font-normal text-[8pt] leading-[1.25]" style={{ fontFamily: '"MiSans", sans-serif' }}>
                  Срок службы 6000+, до 8-10 лет<br/> LiFePO<sub>4</sub> Аккумулятор, высокая безопасность и производительность
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-[4mm]">
              ...
              <div className="flex flex-col gap-[1mm]">
                <h3 className="text-[#010202] font-medium text-[12pt]" style={{ fontFamily: '"MiSans", sans-serif' }}>
                  Сверхбольшая емкость
                </h3>
                <p className="text-[#5A5A5C] font-normal text-[8pt] leading-[1.25]" style={{ fontFamily: '"MiSans", sans-serif' }}>
                  8000Wh LiFePO<sub>4</sub> Аккумулятор<br/> Время резервного копирования до 2 часов
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-[4mm]">
              ...
              <div className="flex flex-col gap-[1mm]">
                ...
                <p className="text-[#5A5A5C] font-normal text-[8pt] leading-[1.25]" style={{ fontFamily: '"MiSans", sans-serif' }}>
                  Выдерживаемое фазное напряжение 380V<br/> Самоадаптация к нестабильной электросети THDv&lt;3%<br/> Самоадаптация к слабой сети
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-[4mm]">
              ...
              <div className="flex flex-col gap-[1mm]">
                ...
                <p className="text-[#5A5A5C] font-normal text-[8pt] leading-[1.25]" style={{ fontFamily: '"MiSans", sans-serif' }}>
                  Класс ИБП Время переключения &lt;10ms<br/> Интеллектуальный режим защиты от перегрузки
                </p>
              </div>
            </div>
          </div>
          ...
          <table className="w-full border-collapse text-[6pt] text-center" style={{ fontFamily: '"Mark OT", sans-serif' }}>
            <tbody>
              ...
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                ...
                <td className="border-[0.368pt] border-white py-[2mm] px-[2mm] align-middle leading-tight">105%~150%, после выключения через 3 с<br/>150%~200%, после выключения через 0,2 с</td>
              </tr>
              ...
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle text-left">Подача в сетку</td>
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">Поддерживать</td>
              </tr>
              <tr className="bg-[#dbdcdb] text-[#231A16]">
              ...
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                ...
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">DC: Тип II, AC: Тип III</td>
              </tr>
            </tbody>
          </table>
        </div>
