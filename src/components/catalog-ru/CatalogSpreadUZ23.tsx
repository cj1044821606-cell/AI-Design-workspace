          ...
          <div className="grid grid-cols-2 gap-x-[8mm] gap-y-[4mm]">
            ...
            <div className="flex items-start gap-[4mm]">
              ...
              <div className="flex flex-col gap-[1mm]">
                ...
                <p className="text-[#5A5A5C] font-normal text-[8pt] leading-[1.25]" style={{ fontFamily: '"MiSans", sans-serif' }}>
                  Самоадаптирующаяся связь с основным инвертором<br/> Макс. Мощность разряда до 16kW при 10 с.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-[4mm]">
              ...
              <div className="flex flex-col gap-[1mm]">
                ...
                <p className="text-[#5A5A5C] font-normal text-[8pt] leading-[1.25]" style={{ fontFamily: '"MiSans", sans-serif' }}>
                  Интегрированная конструкция контактной системы ячеек (CCS) и<br/> Технология изготовления
                </p>
              </div>
            </div>
