...
export default function CatalogSpreadUZ34() {
  return (
    <div className="w-[420mm] h-[297mm] bg-white relative overflow-hidden shadow-sm">
      ...
      <div className="design-group-wrapper absolute left-[299.713mm] top-[119mm] z-10">
        ...
        <h1 className="text-[35pt] font-bold text-[#585857] leading-none" style={{ fontFamily: '"Arial", "Tahoma", sans-serif' }}>
          PV-модули
        </h1>
      </div>
      ...
      <div className="design-group-wrapper absolute left-[335mm] top-[141mm] z-10 flex flex-col">
        ...
        <ul className="text-[10pt] font-normal text-[#585857] leading-[1.8]" style={{ fontFamily: '"Arial", "Tahoma", sans-serif' }}>
          <li>585W/N</li>
          <li>590W/N</li>
          <li>610W/N</li>
          <li>620W/N</li>
