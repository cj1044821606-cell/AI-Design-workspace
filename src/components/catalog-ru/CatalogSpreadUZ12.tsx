...
import inverterImg from '@/画册素材库/产品素材/IHY-6K6L1C.png';
import bgImage from '@/画册素材库/背景素材/画册-12-产品页左上角背景.png';
import { ProductImageEditor } from './ProductImageEditor';

export default function CatalogSpreadUZ12() {
  return (
    <div className="w-[420mm] h-[297mm] bg-white relative overflow-hidden shadow-sm flex">
      ...
      <div className="w-[210mm] h-full relative z-10">
        ...
        <div className="design-group-wrapper absolute left-[100.7mm] top-[106.84mm] w-[100.83mm] h-[93.22mm] z-10">
          ...
          <ProductImageEditor src={inverterImg} componentName="CatalogSpreadUZ12" initialX={41} /* IMAGE_TRANSFORM_X */ initialY={-68} /* IMAGE_TRANSFORM_Y */ initialScale={0.8} /* IMAGE_TRANSFORM_SCALE */ defaultHeight="100%" defaultMarginLeft="0" />
        </div>
        ...
        <div className="design-group-wrapper absolute left-[20.9mm] top-[169.83mm] flex items-center z-10">
          ...
          <div className="bg-[#ED1651] h-[11.2mm] px-4 flex items-center justify-center rounded-l-md z-20">
            <span className="text-white font-bold text-[16pt]" style={{ fontFamily: '"Mark OT", sans-serif' }}>6.6kW/12kW</span>
          </div>
        ...
        {/* 分隔线 */}
        <div className="design-group-wrapper absolute left-[21.5mm] top-[205.5mm] w-[178mm] h-[0.4pt] bg-black z-10">
          <div className="design-group-label">标题下划线</div>
        </div>

        {/* 特性列表 Grid */}
        <div className="design-group-wrapper absolute left-[21.5mm] top-[211mm] w-[178mm] z-10">
          ...
          <div className="grid grid-cols-2 gap-x-[8mm] gap-y-[4mm]">
            ...
            <div className="flex items-start gap-[4mm]">
              ...
              <div className="flex flex-col gap-[1mm]">
                ...
                <p className="text-[#5A5A5C] font-normal text-[8pt] leading-[1.3]" style={{ fontFamily: '"MiSans", sans-serif' }}>
                  Поддержка сетевой, интеллектуальной загрузки и резервной нагрузки
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-[4mm]">
              ...
              <div className="flex flex-col gap-[1mm]">
                ...
                <p className="text-[#5A5A5C] font-normal text-[8pt] leading-[1.3]" style={{ fontFamily: '"MiSans", sans-serif' }}>
                  2 трекера MPP, входная мощность PV до 13200W/24000W<br/> Макс. Ток зарядки от солнечной батареи до 140A/240A
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-[4mm]">
              ...
              <div className="flex flex-col gap-[1mm]">
                ...
                <p className="text-[#5A5A5C] font-normal text-[8pt] leading-[1.3]" style={{ fontFamily: '"MiSans", sans-serif' }}>
                  MPPT Эффективность ≥99%<br/> Максимальная эффективность преобразования режима работы от батареи &gt;93%
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-[4mm]">
              ...
              <div className="flex flex-col gap-[1mm]">
                ...
                <p className="text-[#5A5A5C] font-normal text-[8pt] leading-[1.3]" style={{ fontFamily: '"MiSans", sans-serif' }}>
                  Непрерывная работа под 100%&lt;Load&lt;110%<br/> (если не сработала защита от перегрева)<br/> Интеллектуальный режим времени использования (TOU) для получения пикового тарифа долины
                </p>
              </div>
            </div>

            {/* Feature 5: Highly User-friendly Design */}
            <div className="flex items-start gap-[4mm]">
              <div className="w-[9.46mm] h-[9.46mm] bg-[#ED1651] rounded-[2mm] shrink-0 mt-1"></div>
              <div className="flex flex-col gap-[1mm]">
                <h3 className="text-[#010202] font-medium text-[12pt]" style={{ fontFamily: '"MiSans", sans-serif' }}>Очень удобный дизайн</h3>
                <p className="text-[#5A5A5C] font-normal text-[8pt] leading-[1.3]" style={{ fontFamily: '"MiSans", sans-serif' }}>
                  Низкий уровень шума и отличное рассеивание тепла<br/> Выглядит как бытовая техника с потрясающим внешним видом<br/> ЖК-дисплей с сенсорной кнопкой
                </p>
              </div>
            </div>

            {/* Feature 6: Solid Quality */}
            <div className="flex items-start gap-[4mm]">
              <div className="w-[9.46mm] h-[9.46mm] bg-[#ED1651] rounded-[2mm] shrink-0 mt-1"></div>
              <div className="flex flex-col gap-[1mm]">
                <h3 className="text-[#010202] font-medium text-[12pt]" style={{ fontFamily: '"MiSans", sans-serif' }}>Солидное качество</h3>
                <p className="text-[#5A5A5C] font-normal text-[8pt] leading-[1.3]" style={{ fontFamily: '"MiSans", sans-serif' }}>
                  IP66 Конструкция защиты для суровых условий окружающей среды<br/> Гарантия 5 лет
                </p>
              </div>
            </div>
          ...
          <table className="w-full border-collapse text-[6pt] text-center" style={{ fontFamily: '"Mark OT", sans-serif' }}>
            <tbody>
              ...
              <tr className="bg-[#9e9e9e] text-white font-bold">
                ...
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle w-1/4">IHY-6K6L1C</td>
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle w-1/4">IHY-12KL1C</td>
              </tr>
              ...
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                ...
                <td colSpan={2} className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">&gt;93%</td>
              </tr>
              ...
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                ...
                <td colSpan={2} className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">60</td>
              </tr>
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle text-left">MPPT Диапазон напряжения (В)</td>
                <td colSpan={2} className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">60-425</td>
              </tr>
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                ...
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">40/40</td>
              </tr>
              <tr className="bg-[#dbdcdb] text-[#231A16]">
              ...
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                ...
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">50 (режим байпаса)</td>
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">80 (Bypass Mode)</td>
              </tr>
              <tr className="bg-[#dbdcdb] text-[#231A16]">
              ...
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                ...
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">55</td>
              </tr>
              <tr className="bg-[#dbdcdb] text-[#231A16]">
              ...
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                ...
                <td colSpan={2} className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">&lt;20 (Бытовая техника)</td>
              </tr>
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle text-left">Impульсная мощность (ВА)</td>
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">13200 @ 5s</td>
              ...
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                ...
                <td colSpan={2} className="border-[0.368pt] border-white py-[2mm] px-[2mm] align-middle leading-tight">
                  110%≤Загрузка&lt;140% @ 10 с<br/> 140%≤Загрузка&lt;200% @ 7 с
                </td>
              </tr>
              ...
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                ...
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">240</td>
              </tr>
              <tr className="bg-[#dbdcdb] text-[#231A16]">
              ...
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                ...
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">25</td>
              </tr>
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle text-left">Диапазон рабочих температур (°C))</td>
                <td colSpan={2} className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">-40 ~ +60 (&gt;45°C Снижение мощности)</td>
              </tr>
              <tr className="bg-[#dbdcdb] text-[#231A16]">
              ...
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                ...
                <td colSpan={2} className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">Wi-Fi/RS485/CAN/сухой контакт</td>
              </tr>
              <tr className="bg-[#dbdcdb] text-[#231A16]">
              ...
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                ...
                <td colSpan={2} className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">Максимум 12 единиц</td>
              </tr>
              <tr className="bg-[#dbdcdb] text-[#231A16]">
              ...
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle text-left">Защита от перенапряжения</td>
                <td colSpan={2} className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">DC: ТИП II; AC: ТИП III</td>
              </tr>
            </tbody>
          </table>
        </div>
