...
export default function CatalogSpreadGlobal20260420_31C() {
  return (
    <div className="w-[420mm] h-[297mm] bg-white relative overflow-hidden shadow-sm flex">
      <div className="w-[210mm] h-full relative z-10">
        ...
        <div className="design-group-wrapper absolute left-[85.7mm] top-[106.84mm] w-[110.83mm] h-[93.22mm] z-10">
          ...
          <ProductImageEditor
            src={productImage}
            componentName="CatalogSpreadGlobal20260420_31C"
          ...
          <div className="grid grid-cols-2 gap-x-[10mm] gap-y-[10mm]">
            <div className="flex items-start gap-[4mm]">
              ...
              <div className="flex flex-col gap-[1mm]">
                ...
                <p className="text-[#5A5A5C] font-normal text-[8pt] leading-[1.4]" style={{ fontFamily: '"MiSans", sans-serif' }}>
                  100% Unbalanced Output Enhances Self-consumption
                  <br />
                  150A Charge/Discharge for Efficient Energy Transfer
                  <br />
                  150-840V Super Wide Battery Voltage Range
                  <br />
                  160% DC Oversizing Boosts Efficiency,
                  <br />
            ...
            <div className="flex items-start gap-[4mm]">
              ...
              <div className="flex flex-col gap-[1mm]">
                ...
                <p className="text-[#5A5A5C] font-normal text-[8pt] leading-[1.4]" style={{ fontFamily: '"MiSans", sans-serif' }}>
                  Max. Parallel Number (On-Grid) 10
                  <br />
                  150% Max Backup @10s Handles Overloads
                  <br />
                  IP66 Protects both Indoors and Outdoors
                  <br />
            ...
            <div className="flex items-start gap-[4mm]">
              ...
              <div className="flex flex-col gap-[1mm]">
                ...
                <p className="text-[#5A5A5C] font-normal text-[8pt] leading-[1.4]" style={{ fontFamily: '"MiSans", sans-serif' }}>
                  6 Work Modes for Diverse Use
                  <br />
                  Supports Both TOU and Dynamic Pricing Strategies
                  <br />
                  for Optimized Energy Use and Cost Savings
                  <br />
            ...
            <div className="flex items-start gap-[4mm]">
              ...
              <div className="flex flex-col gap-[1mm]">
                ...
                <p className="text-[#5A5A5C] font-normal text-[8pt] leading-[1.4]" style={{ fontFamily: '"MiSans", sans-serif' }}>
                  Remote Upgrades Maintain System Health
                  <br />
                  Fast Commissioning through Bluetooth
                  <br />
                  Advanced EMS Platform for Peak Intelligent
                  <br />
                  Energy Management
                </p>
              </div>
          ...
          <table className="w-full border-collapse text-[6pt] text-center" style={{ fontFamily: '"Mark OT", sans-serif' }}>
            <tbody>
              <tr className="bg-[#9e9e9e] text-white font-bold">
                ...
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle w-1/2">IHY-50KH3S</td>
              </tr>

              <tr className="bg-[#cac9c8] text-[#231A16] font-bold">
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle text-left" colSpan={2}>Efficiency</td>
              </tr>
              ...
              <tr className="bg-[#cac9c8] text-[#231A16] font-bold">
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle text-left" colSpan={2}>PV Input</td>
              </tr>
              <tr className="bg-[#dbdcdb] text-[#231A16]">
              ...
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                ...
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">135</td>
              </tr>
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle text-left">MPPT Voltage Range (V)</td>
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">200~950</td>
              </tr>
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle text-left">Max. Input Current (A)</td>
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">40/40/40/40</td>
              </tr>
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle text-left">Number of MPPT</td>
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">4</td>
              </tr>
              <tr className="bg-[#dbdcdb] text-[#231A16]">
              ...
              <tr className="bg-[#cac9c8] text-[#231A16] font-bold">
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle text-left" colSpan={2}>AC Input</td>
              </tr>
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle text-left">Nominal Input Voltage (Vac)</td>
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">220/380V; 230/400V(3L+N+PE)</td>
              </tr>
              <tr className="bg-[#dbdcdb] text-[#231A16]">
              ...
              <tr className="bg-[#cac9c8] text-[#231A16] font-bold">
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle text-left" colSpan={2}>AC Output</td>
              </tr>
              <tr className="bg-[#dbdcdb] text-[#231A16]">
              ...
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                ...
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">110%&lt;Load≤150% @ 10s</td>
              </tr>

              <tr className="bg-[#cac9c8] text-[#231A16] font-bold">
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle text-left" colSpan={2}>Battery</td>
              </tr>
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle text-left">Battery Type</td>
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">Lithium-ion</td>
              </tr>
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle text-left">Battery Voltage Range (V)</td>
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">150-840</td>
              </tr>
              <tr className="bg-[#dbdcdb] text-[#231A16]">
              ...
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                ...
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">150/150</td>
              </tr>
              <tr className="bg-[#dbdcdb] text-[#231A16]">
              ...
              <tr className="bg-[#cac9c8] text-[#231A16] font-bold">
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle text-left" colSpan={2}>General</td>
              </tr>
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle text-left">Dimensions (L*W*H, mm)</td>
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">909*735*305</td>
              </tr>
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle text-left">Net Weight (kg)</td>
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">89</td>
              </tr>
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle text-left">Operating Temperature Range (&deg;C)</td>
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">-30 ~ +60 (&gt;45&deg;C Power Derating)</td>
              </tr>
              <tr className="bg-[#dbdcdb] text-[#231A16]">
              ...
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                ...
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">Wi-Fi/CAN/RS485/Dry Contact/LAN (Optional)</td>
              </tr>
              <tr className="bg-[#dbdcdb] text-[#231A16]">
              ...
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                ...
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">&lt;65</td>
              </tr>
              <tr className="bg-[#dbdcdb] text-[#231A16]">
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle text-left">Authentication Level</td>
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle">IEC62109/IEC61000</td>
              </tr>

              <tr className="bg-[#cac9c8] text-[#231A16] font-bold">
                <td className="border-[0.368pt] border-white h-[4.551mm] px-[2mm] align-middle text-left" colSpan={2}>Protection</td>
              </tr>
              <tr className="bg-[#dbdcdb] text-[#231A16]">
