...
import bgImage from '@/画册素材库/背景素材/画册-05-逆变器章节背景-最新全球版.png';

export default function CatalogSpreadGlobal20260420_05() {
  return (
    <div className="w-[420mm] h-[297mm] bg-white relative overflow-hidden shadow-sm">
      <div className="design-group-wrapper absolute left-0 top-0 w-[420mm] h-[297mm] z-0">
        <div className="design-group-label">Background</div>
      ...
      <div className="design-group-wrapper absolute left-[299.713mm] top-[119mm] z-10">
        <div className="design-group-label">Title</div>
        <h1
          className="text-[35pt] font-bold text-[#585857] leading-none"
      ...
      <div className="design-group-wrapper absolute left-[333.37mm] top-[140.5mm] z-10 flex flex-col">
        <div className="design-group-label">Product List</div>

        <h3
          className="text-[10pt] font-medium text-[#585857] leading-[1.5] mb-1"
          style={{ fontFamily: '"Mark OT", sans-serif' }}
        >
          Hybrid Inverter
        </h3>
        <ul
          className="text-[10pt] font-normal text-[#585857] leading-[1.5] mb-2"
          style={{ fontFamily: '"Mark OT", sans-serif' }}
        >
          <li>IPV-1K612U</li>
          <li>IPV-3K24U Pro</li>
        ...
        <ul
          className="text-[10pt] font-normal text-[#585857] leading-[1.5]"
          style={{ fontFamily: '"Mark OT", sans-serif' }}
        >
