...
export default function CatalogSpread05() {
  return (
    <div className="w-[420mm] h-[297mm] bg-white relative overflow-hidden shadow-sm">
      ...
      <div className="design-group-wrapper absolute left-[333.37mm] top-[140.5mm] z-10 flex flex-col">
        ...
        <h3 className="text-[10pt] font-medium text-[#585857] leading-[1.5] mb-1" style={{ fontFamily: '"Mark OT", sans-serif' }}>Hybrid Inverter</h3>
        ...
        <h3 className="text-[10pt] font-medium text-[#585857] leading-[1.5] mb-1" style={{ fontFamily: '"Mark OT", sans-serif' }}>On-Grid Inverter</h3>
